...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.username'
        db.alter_column('board_post', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Post.username'
        db.alter_column('board_post', 'username', self.gf('django.db.models.fields.CharField')(blank=True, max_length=255))
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 22, 11, 55, 36, 693000)', 'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Mention', fields ['post', 'user']
        db.create_unique('board_mention', ['post_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Mention', fields ['post', 'user']
        db.delete_unique('board_mention', ['post_id', 'user_id'])
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 13, 14, 16, 2, 811000)', 'db_index': 'True'}),

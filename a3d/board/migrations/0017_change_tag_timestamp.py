...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for item in orm.Tag.objects.all():
            item.timestamp = int(time.mktime(item.last_attach.timetuple()))
            item.save()
    ...
    models = {
        ...
        'board.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_attach': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 12, 35, 33, 400921)'}),
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 12, 35, 33, 403484)', 'db_index': 'True'}),

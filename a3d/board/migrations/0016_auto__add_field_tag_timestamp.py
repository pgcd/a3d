...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_tag', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tag.timestamp'
        db.delete_column('board_tag', 'timestamp')
    ...
    models = {
        ...
        'board.tag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'last_attach': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 12, 42, 40, 31092)'}),
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 12, 42, 40, 33927)', 'db_index': 'True'}),

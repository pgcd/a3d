...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.last_poster_name'
        db.add_column('board_post', 'last_poster_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.last_poster_name'
        db.delete_column('board_post', 'last_poster_name')
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 10, 11, 54, 33, 296000)', 'db_index': 'True'}),

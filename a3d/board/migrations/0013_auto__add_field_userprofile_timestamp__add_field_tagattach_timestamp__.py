...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_userprofile', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True, blank=True), keep_default=False)

        # Adding field 'TagAttach.timestamp'
        db.add_column('board_tagattach', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True, blank=True), keep_default=False)

        # Deleting field 'Tag.reverse_timestamp'
        db.delete_column('board_tag', 'reverse_timestamp')

        # Adding field 'Post.timestamp'
        db.add_column('board_post', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.timestamp'
        db.delete_column('board_userprofile', 'timestamp')

        # Deleting field 'TagAttach.timestamp'
        db.delete_column('board_tagattach', 'timestamp')

        # Adding field 'Tag.reverse_timestamp'
        db.add_column('board_tag', 'reverse_timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Deleting field 'Post.timestamp'
        db.delete_column('board_post', 'timestamp')
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 11, 50, 47, 775911)', 'db_index': 'True'}),

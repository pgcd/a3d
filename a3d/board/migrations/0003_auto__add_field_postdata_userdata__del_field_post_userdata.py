...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PostData.userdata'
        db.add_column('board_postdata', 'userdata', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Deleting field 'Post.userdata'
        db.delete_column('board_post', 'userdata')


    def backwards(self, orm):
        
        # Deleting field 'PostData.userdata'
        db.delete_column('board_postdata', 'userdata')

        # Adding field 'Post.userdata'
        db.add_column('board_post', 'userdata', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

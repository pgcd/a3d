...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.timestamp'
        db.alter_column('board_userprofile', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Adding index on 'UserProfile', fields ['timestamp']
        db.create_index('board_userprofile', ['timestamp'])

        # Changing field 'TagAttach.timestamp'
        db.alter_column('board_tagattach', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Adding index on 'TagAttach', fields ['timestamp']
        db.create_index('board_tagattach', ['timestamp'])

        # Changing field 'Post.timestamp'
        db.alter_column('board_post', 'timestamp', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Removing index on 'TagAttach', fields ['timestamp']
        db.delete_index('board_tagattach', ['timestamp'])

        # Removing index on 'UserProfile', fields ['timestamp']
        db.delete_index('board_userprofile', ['timestamp'])

        # Changing field 'UserProfile.timestamp'
        db.alter_column('board_userprofile', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TagAttach.timestamp'
        db.alter_column('board_tagattach', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Post.timestamp'
        db.alter_column('board_post', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 41, 18, 5832)', 'db_index': 'True'}),

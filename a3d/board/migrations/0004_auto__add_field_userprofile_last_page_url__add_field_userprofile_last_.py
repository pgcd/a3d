...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.last_page_url'
        db.add_column('board_userprofile', 'last_page_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'UserProfile.last_page_time'
        db.add_column('board_userprofile', 'last_page_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 7, 13, 10, 59, 30, 959000)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.last_page_url'
        db.delete_column('board_userprofile', 'last_page_url')

        # Deleting field 'UserProfile.last_page_time'
        db.delete_column('board_userprofile', 'last_page_time')
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 13, 10, 59, 30, 959000)'}),

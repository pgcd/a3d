...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.reverse_timestamp'
        db.delete_column('board_userprofile', 'reverse_timestamp')

        # Deleting field 'TagAttach.reverse_timestamp'
        db.delete_column('board_tagattach', 'reverse_timestamp')

        # Deleting field 'Post.reverse_timestamp'
        db.delete_column('board_post', 'reverse_timestamp')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.reverse_timestamp'
        db.add_column('board_userprofile', 'reverse_timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'TagAttach.reverse_timestamp'
        db.add_column('board_tagattach', 'reverse_timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Post.reverse_timestamp'
        db.add_column('board_post', 'reverse_timestamp', self.gf('django.db.models.fields.PositiveIntegerField')(default=4294967295L, db_index=True), keep_default=False)
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 11, 56, 56, 927137)', 'db_index': 'True'}),

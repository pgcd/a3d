...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mention.user'
        db.alter_column('board_mention', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Adding field 'Post.is_private'
        db.add_column('board_post', 'is_private', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Mention.user'
        db.alter_column('board_mention', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['board.UserProfile']))

        # Deleting field 'Post.is_private'
        db.delete_column('board_post', 'is_private')
    ...
    models = {
        ...
        'board.mention': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mentions'", 'to': "orm['board.Post']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mentions'", 'to': "orm['auth.User']"})
        },
        'board.post': {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 13, 18, 43, 21, 950000)', 'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tag.last_attach'
        db.delete_column('board_tag', 'last_attach')


    def backwards(self, orm):
        
        # Adding field 'Tag.last_attach'
        db.add_column('board_tag', 'last_attach', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 22, 12, 35, 33, 400921)), keep_default=False)
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 22, 12, 43, 18, 204791)', 'db_index': 'True'}),

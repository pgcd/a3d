...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExtendedAttribute.applies_to'
        db.add_column('board_extendedattribute', 'applies_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)

        # Adding field 'ExtendedAttribute.editable'
        db.add_column('board_extendedattribute', 'editable', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExtendedAttribute.applies_to'
        db.delete_column('board_extendedattribute', 'applies_to_id')

        # Deleting field 'ExtendedAttribute.editable'
        db.delete_column('board_extendedattribute', 'editable')
    ...
    models = {
        ...
        'board.extendedattribute': {
            ...
            'applies_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 25, 11, 23, 56, 181000)', 'db_index': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PostDataVersion'
        db.create_table('board_postdataversion', (
            ...
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name='versions', to=orm['board.PostData'])),
            ('body_markup', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('board', ['PostDataVersion'])


    def backwards(self, orm):
        
        # Deleting model 'PostDataVersion'
        db.delete_table('board_postdataversion')

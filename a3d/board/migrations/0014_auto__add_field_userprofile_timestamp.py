...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_userprofile', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 19, 15, 14, 16, 980552)), keep_default=False)
    ...
    models = {
        ...
        'board.post': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 14, 16, 972514)', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        'board.tagattach': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 14, 16, 975593)'})
        },
        'board.template': {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 14, 16, 980608)', 'db_index': 'True'}),
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 14, 16, 980552)'}),

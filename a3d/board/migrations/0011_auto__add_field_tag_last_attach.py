...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_tag', 'last_attach', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 21, 14, 57, 24, 707000)', 'db_index': 'True'}),

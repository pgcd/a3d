...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('board_tagattach', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 19, 15, 9, 1, 887976)), keep_default=False)

        # Adding field 'Post.timestamp'
        db.add_column('board_post', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 19, 15, 9, 1, 884176), db_index=True), keep_default=False)
    ...
    models = {
        ...
        'board.post': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 9, 1, 884176)', 'db_index': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        'board.tagattach': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 9, 1, 887976)'})
        },
        'board.template': {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 9, 1, 892882)', 'db_index': 'True'}),

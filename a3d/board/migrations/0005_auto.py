...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'UserProfile', fields ['last_page_time']
        db.create_index('board_userprofile', ['last_page_time'])


    def backwards(self, orm):
        
        # Removing index on 'UserProfile', fields ['last_page_time']
        db.delete_index('board_userprofile', ['last_page_time'])
    ...
    models = {
        ...
        'board.userprofile': {
            ...
            'last_page_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 13, 11, 15, 25, 723000)', 'db_index': 'True'}),
